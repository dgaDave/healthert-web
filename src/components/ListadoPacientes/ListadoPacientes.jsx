...
const InfoCompleta = ({ nombre, curp , edad, peso,altura, grupS, genero, numSeg , alergias, padecimientos}) => {
    ...
    return (
       ...
       <div className={`flex absolute bottom-0 right-0 w-3/4 h-2/5 shadow-xl dark:bg-slate-800 p-5 transition transform duration-300 ${isSmall ? 'collapse' : 'vivisble'}`}>
       <div className='grid justify-start items-center px-2'>
           <div className='items-center'>
               <img src='' alt='fotoPaciente '></img>
           </div>
